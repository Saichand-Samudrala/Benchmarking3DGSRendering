...
var radius := 12  # Radius of the circle
var center := Vector3(0, 3, 0)  # The point around which the camera rotates
var step := Vector3(0, 2, 0) # Steps for camera position updates
...
var initial_configs = [
	{ "position": Vector3(-12, 1, 0.5), "rotation": Vector3(-20, -88, 0) } # ypos= 1 to 23 with steps of 2
]

...
var radius := 3  # Radius of the circle
var center := Vector3(0, -0.7, 0)  # The point around which the camera rotates
...
var initial_configs = [
	{ "position": Vector3(0, -0.8, -3), "rotation": Vector3(0, 180, 0) } #y = -0.8 to 0.8
]

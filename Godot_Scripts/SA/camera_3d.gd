...
var center := Vector3(0, 70, 0)  # The point around which the camera rotates
var step := Vector3(0, 10, 0) # Steps for camera position updates
...
var initial_configs = [
	{ "position": Vector3(5, -50, 100), "rotation": Vector3(0, 0, 0) } # y goes from -50 to 140 in the steps of 10
]
